       ...
       <div class="container-fluid">
          ...
          <div class="row align-items-center title text" id="topmark">
            ...
            <div class="col-md-6 col-12 text-center">
              <span class="text-center text-white font-weight-bold h5">Find <a href="/artisans"><span style="color:#C33764;text-decoration:underline;">Artisans</span></a> in Nigeria</span>
