                        ...
                        <div class='col-md-11 col-12 mb-4 art-card card'>
                            <div class='row'>
                                ...
                                <div class='col-7 infoside text-left align-items-center'>
                                    <p class='infopar compname font-weight-bolder'><a href='/artisans/$artisan->slog'>$artisan->companyname ($artisan->slog)</a></p>
                                    <p class='infopar smal'>$artisan->city, $artisan->state state.</p>
                                    <p class='infopar smal'>$artisan->services</p>
